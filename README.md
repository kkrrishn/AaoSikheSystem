...
├── js/                 # Logic and Framework core scripts
...
3. If you have specific technologies (like React, Node.js, or PHP) inside your repo, update the **Tech Stack** section accordingly.
4. If you have a working demo, I recommend adding a **Screenshot** under the title!
